            ...
            <form id="{{ $formId }}" class="mt-4 space-y-4">
                ...
                <div>
                    ...
                    <textarea name="body" id="{{ $isEdit ? 'edit' : 'create' }}_body" rows="5" required
                        class="hidden mt-1 px-3 py-2 block w-full rounded-md border-slate-300 dark:border-stone-600 dark:bg-stone-700 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"></textarea>
                    
                    <div id="{{ $isEdit ? 'edit' : 'create' }}_body_editor" class="mt-1 px-3 py-2 block w-full rounded-md border-slate-300 dark:border-stone-600 dark:bg-stone-700 dark:text-white shadow-sm focus:border-red-500 focus:ring-red-500 sm:text-sm"></div>
