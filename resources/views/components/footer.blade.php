<footer>
    <div class="bg-[#2B2A29] text-[#FDFDFD] py-8 lg:py-12 px-6 sm:px-10 lg:px-16 text-xs lg:text-sm">
        <div class="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div class="space-y-3">
                ...
                <ul class="space-y-1.5 md:grid md:grid-cols-2 md:gap-x-6 md:gap-y-1.5 md:space-y-0">
                    <li><a href="{{ route('home') }}"
                            class="hover:text-gray-300 hover:underline transition-colors">Beranda</a></li>
                    <li><a href="{{ route('profile') }}"
                            class="hover:text-gray-300 hover:underline transition-colors">Profil</a></li>
                    <li><a href="{{ route('news') }}"
                            class="hover:text-gray-300 hover:underline transition-colors">Berita</a></li>
                    <li><a href="{{ route('gallery') }}"
                            class="hover:text-gray-300 hover:underline transition-colors">Galeri</a></li>
                    <li><a href="{{ route('services') }}"
                            class="hover:text-gray-300 hover:underline transition-colors">Layanan Publik</a> </li>
                    <li><a href="{{ route('services') }}/#contact"
                            class="hover:text-gray-300 hover:underline transition-colors">Kontak Kami</a></li>
                    <li><a href="https://data.semarangkota.go.id/" target="_blank" rel="noopener noreferrer"
                            class="hover:text-gray-300 hover:underline transition-colors">Satu Data Kota Semarang</a>
                    </li>
                    <li><a href="https://semarangkota.go.id/" target="_blank" rel="noopener noreferrer"
                            class="hover:text-gray-300 hover:underline transition-colors">Website Kota Semarang</a></li>
                    <li><a href="https://smartcity.semarangkota.go.id/" target="_blank" rel="noopener noreferrer"
                            class="hover:text-gray-300 hover:underline transition-colors">Smart City Semarang</a></li>
                    <li><a href="https://ppid.semarangkota.go.id/" target="_blank" rel="noopener noreferrer"
                            class="hover:text-gray-300 hover:underline transition-colors">PPID Kota Semarang</a></li>
                </ul>
            </div>
            ...
            <div class="space-y-3">
                ...
                <address class="not-italic space-y-1.5">
                    ...
                    <p>Email: <a href="mailto:satpolpp@semarangkota.go.id"
                            class="hover:text-gray-300 hover:underline transition-colors">satpolpp@semarangkota.go.id</a>
                    </p>
                </address>
                {{-- <div class="mt-4">
