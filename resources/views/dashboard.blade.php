<x-layout :pageName="'Dashboard'">
    ...
    <main>
        ...
        <div id="imageSliderViewport" class="relative max-w-screen overflow-hidden h-[60vh]">
            ...
            <div
                id="imageSliderTrack" class="relative w-[300vw] h-[100%] flex transition-all duration-500 ease-in-out peer-checked/slider1:-left-0 peer-checked/slider2:-left-[100vw] peer-checked/slider3:-left-[200vw]">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            sliderViewport.addEventListener('touchstart', handleDragStart, { passive: true });
