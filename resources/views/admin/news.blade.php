                ...
                <tbody class="bg-white dark:bg-stone-700 divide-y divide-slate-200 dark:divide-stone-600">
                        ...
                        if (!isset($newsItems)) {
                            $newsItems = collect([
                                (object) [
                                    ...
                                    'body' =>
                                        'This is the body of the first news. It might be quite long and should be truncated for the table view.',
                                ...
                                (object) [
                                    ...
                                    'body' =>
                                        'Another piece of news content for demonstration purposes. This shows how text overflows if not handled.',
                                ...
                                (object) [
                                    ...
                                    'body' =>
                                        'Important updates regarding recent events and system changes are included here. This body is a bit longer to test truncation.',
                    ...
                    @forelse ($newsItems as $item)
                        <tr>
                            ...
                            <td class="text-sm">
                                {{ $item->title }}</td>
                            <td class="text-sm" title="{{ $item->body }}">{{ Str::limit($item->body, 70) }}</td>
                            <td class="text-sm">
